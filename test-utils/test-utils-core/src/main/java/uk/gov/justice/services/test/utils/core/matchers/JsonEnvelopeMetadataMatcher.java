...
public class JsonEnvelopeMetadataMatcher extends TypeSafeDiagnosingMatcher<Metadata> {
    ...
    //TODO:     withMetadataEnvelopedFrom(final Envelope<?> jsonEnvelope) {

    public static JsonEnvelopeMetadataMatcher
    withMetadataEnvelopedFrom(final Envelope<?> jsonEnvelope) {
